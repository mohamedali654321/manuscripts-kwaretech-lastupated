...
@Component({
  ...
  standalone: true,
  imports: [NgIf, ThemedLoadingComponent, VarDirective, PaginationComponent, NgFor, SubscriptionViewComponent, AlertComponent, AsyncPipe, TranslateModule,KwareTranslatePipe],
})
/**
