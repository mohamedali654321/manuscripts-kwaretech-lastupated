...
@listableObjectComponent('SiteSearchResult', ViewMode.GridElement)
@Component({
  selector: 'ds-site-search-result-grid-element',
  styleUrls: ['./site-search-result-grid-element.component.scss'],
  templateUrl: './site-search-result-grid-element.component.html',
 ...
 */
export class SiteSearchResultGridElementComponent extends ItemSearchResultGridElementComponent {
    // kware-edit
