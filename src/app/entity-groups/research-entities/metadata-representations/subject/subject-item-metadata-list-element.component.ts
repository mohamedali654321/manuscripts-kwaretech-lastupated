...
@Component({
  selector: 'ds-subject-item-metadata-list-element',
  templateUrl: './subject-item-metadata-list-element.component.html',
  standalone: true,
 ...
 */
export class SubjectItemMetadataListElementComponent extends ItemMetadataRepresentationListElementComponent {
