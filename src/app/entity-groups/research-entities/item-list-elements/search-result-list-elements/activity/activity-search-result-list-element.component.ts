...
@listableObjectComponent('ActivitySearchResult', ViewMode.ListElement)
@Component({
  selector: 'ds-activity-search-result-list-element',
  styleUrls: ['./activity-search-result-list-element.component.scss'],
  templateUrl: './activity-search-result-list-element.component.html',
  standalone: true,
 ...
 */
export class ActivitySearchResultListElementComponent extends ItemSearchResultListElementComponent {
