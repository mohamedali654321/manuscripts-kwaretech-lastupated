...
@Component({
  selector: 'ds-search-publication-category',
  templateUrl: './search-publication-category.component.html',
  styleUrls: ['./search-publication-category.component.scss'],
  standalone: true,
  imports:[ThemedLoadingComponent,SearchCategoriesComponent,SearchCategoryContentComponent,ObjectCollectionComponent,VarDirective, NgIf]
})
export class SearchPublicationCategoryComponent implements OnInit, OnDestroy {
  pubCategories = [];
  pubCategoriesConfig = {
