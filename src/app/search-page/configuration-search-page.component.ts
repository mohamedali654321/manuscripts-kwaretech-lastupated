...
@Component({
  ...
  standalone: true,
  imports: [NgIf, NgTemplateOutlet, PageWithSidebarComponent, ViewModeSwitchComponent, ThemedSearchResultsComponent, ThemedSearchSidebarComponent, SearchBrowseCategoriesComponent, ThemedSearchFormComponent, SearchLabelsComponent, AsyncPipe, TranslateModule],
})
